    ...
    <>
      <Helmet title="Register">
        ...
        <div className="flex justify-center">
          <form className="form bg-[#fde4e4] md:w-[27%]  my-10 rounded-[5px]">

            <div className="form_group ml-5 pt-3 mr-3 pb-3 border-b-2 border-[rgba(33,34,69,.2980392156862745)]">
              <input className="w-[100%] border-none bg-[#fde4e4] outline-none" type="text" placeholder="Enter Your Name" required />
            </div>
        ...
        <div className="flex justify-center mb-10 hover:text-[#0a58ca]">
          <div className="text-gray-600"> <Link to="/Login">Already have an account ? <span>Login</span></Link></div>
        </div>
